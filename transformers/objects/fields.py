...
class AbstractFieldType(object):
    ...
    def coerce(self, obj, attr, value):
        ...
        This method should transformers the value given into the designated type,
...
class Field(object):
    ...
    def coerce(self, obj, attr, value):
        ...
        the proper type, or can be sanely transformersed.
...
class DictProxyField(object):
    ...
    keys, allowing that will transformers back to string-keyed dict.
