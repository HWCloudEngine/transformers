...
core_opts = [
    cfg.StrOpt('api_paste_config',
               ...
               help='File name for the paste.deploy config for transformers-api'),
    cfg.StrOpt('state_path',
               default='/var/lib/transformers',
               deprecated_name='pybasedir',
               help="Top-level directory for maintaining transformers's state"), ]
...
global_opts = [
    ...
    cfg.ListOpt('glance_api_servers',
                ...
                help='A list of the glance API servers available to transformers '
                     '([hostname|ip]:port)'),
    ...
    cfg.ListOpt('osapi_volume_ext_list',
                ...
                help='Specify list of extensions to load when using osapi_'
                     'volume_extension option with transformers.api.contrib.'
                     'select_extensions'),
    cfg.MultiStrOpt('osapi_volume_extension',
                    default=['transformers.api.contrib.standard_extensions'],
    ...
    cfg.StrOpt('rootwrap_config',
               default='/etc/transformers/rootwrap.conf',
    ...
    cfg.StrOpt('volume_api_class',
               default='transformers.volume.cinder.API',
               help='The full class name of the volume API class to use'),
    cfg.StrOpt('backup_api_class',
               default='transformers.backup.api.API',
