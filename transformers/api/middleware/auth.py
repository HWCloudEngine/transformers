...
from transformers.api.middleware import request_id
...
from transformers import wsgi as base_wsgi
...
class InjectContext(base_wsgi.Middleware):
    ...
    def __call__(self, req):
        req.environ['transformers.context'] = self.context
        return self.application


class TransKeystoneContext(base_wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        req.environ['transformers.context'] = ctx
        return self.application
