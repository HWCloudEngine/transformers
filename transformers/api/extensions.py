...
import transformers.api.wsgi
from transformers.api.wsgi import wsgi
from transformers.api import xmlutil
from transformers import exception
from transformers.i18n import _LE, _LI, _LW
import transformers.policy
...
class ExtensionManager(object):
    ...
    See transformers/tests/api/extensions/foxinsocks/extension.py for an
...
class ControllerExtension(object):
    """Extend core controllers of transformers OpenStack API.

    Provide a way to extend existing transformers OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in transformers."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        transformers.policy.enforce(context, act, target)
    return authorize
